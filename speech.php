...
use function Google\Cloud\Samples\Storage\upload_object;
use function Google\Cloud\Samples\Storage\upload_encrypted_object;
...
$application->command('transcribe video-file [-l|--language=] [-e|--encoding=] [-b|--brand-file=] [-r|--rate-hertz=]',
    function ($videoFile, $language = 'tr-TR', $encoding = 2, $brandFile = "brands", $rateHertz = 48000) {
